...
function getDetailErrorStatePerWeek(reqData, callback) {
    var sql_detail_error_state =
        'SELECT a.date, a.teamName, a.teamNo, b.teamLeader, a.name, a.teamPosition, a.workDetails, a.obstacleClassification, a.obstacleDetails, a.obstacleStartTime, a.obstacleEndTime, a.obstaclePhenomenon, a.obstacleResult ' +
        'FROM (SELECT date_format(r.date, \'%Y-%m-%d\') date, t.name teamName, t.team_no teamNo, e.name, e.team_position teamPosition, rd.work_details workDetails, rd.obstacle_classification obstacleClassification, rd.obstacle_details obstacleDetails, rd.obstacle_start_time obstacleStartTime, rd.obstacle_end_time obstacleEndTime, rd.obstacle_phenomenon obstaclePhenomenon, rd.obstacle_result obstacleResult ' +
              'FROM team t JOIN report r ON (t.id = r.team_id) ' +
                          'JOIN report_details rd ON (rd.report_id = r.id) ' +
                          'JOIN employee e ON (e.id = r.employee_id) ' +
              ...
              'ORDER BY date dESC) a JOIN (SELECT DISTINCT e.name teamLeader, r.team_id, r.date ' +
                                          'FROM report r JOIN employee e ON (r.employee_id = e.id) ' +
                                          'WHERE r.type = 1 AND r.team_position = \'조장\' AND r.date BETWEEN STR_TO_DATE(?, \'%Y-%m-%d\') AND STR_TO_DATE(?, \'%Y-%m-%d\') AND r.team_id = ?) b ON (a.date = b.date) ' +
        'ORDER BY date DESC';
    ...
    dbPool.getConnection(function(err, dbConn) {
        ...
        dbConn.query(sql_detail_error_state, [reqData.teamId, reqData.startDay, reqData.endDay, reqData.obstacleClassification, reqData.startDay, reqData.endDay, reqData.teamId], function(err, results) {
            dbConn.release();
            if (err) {
                return callback(err);
            }
...
function getDetailErrorStatePerMonth(reqData, callback) {
    var sql_detail_error_state =
        ...
        'FROM (SELECT date_format(r.date, \'%Y-%m-%d\') date, t.name teamName, t.team_no teamNo, e.name, e.team_position teamPosition, rd.work_details workDetails, rd.obstacle_classification obstacleClassification, rd.obstacle_details obstacleDetails, rd.obstacle_start_time obstacleStartTime, rd.obstacle_end_time obstacleEndTime, rd.obstacle_phenomenon obstaclePhenomenon, rd.obstacle_result obstacleResult ' +
              ...
              'ORDER BY date dESC) a JOIN (SELECT DISTINCT e.name teamLeader, r.team_id, r.date ' +
                                          'FROM report r JOIN employee e ON (r.employee_id = e.id) ' +
                                          'WHERE r.type = 1 AND r.team_position = \'조장\' AND YEAR(r.date) = ? ANd MONTH(r.date) = ? AND r.team_id = ?) b ON (a.date = b.date) ' +
        'ORDER BY date DESC';
    ...
    dbPool.getConnection(function(err, dbConn) {
        ...
        dbConn.query(sql_detail_error_state, [reqData.teamId, reqData.year, reqData.month, reqData.obstacleClassification, reqData.year, reqData.month, reqData.teamId], function(err, results) {
            dbConn.release();
            if (err) {
                return callback(err);
            }
...
function getDetailErrorStatePerQuarter(reqData, callback) {
    var sql_detail_error_state =
        ...
        'FROM (SELECT date_format(r.date, \'%Y-%m-%d\') date, t.name teamName, t.team_no teamNo, e.name, e.team_position teamPosition, rd.work_details workDetails, rd.obstacle_classification obstacleClassification, rd.obstacle_details obstacleDetails, rd.obstacle_start_time obstacleStartTime, rd.obstacle_end_time obstacleEndTime, rd.obstacle_phenomenon obstaclePhenomenon, rd.obstacle_result obstacleResult ' +
              ...
              'ORDER BY date dESC) a JOIN (SELECT DISTINCT e.name teamLeader, r.team_id, r.date ' +
                                          'FROM report r JOIN employee e ON (r.employee_id = e.id) ' +
                                          'WHERE r.type = 1 AND r.team_position = \'조장\' AND YEAR(r.date) = ? ANd QUARTER(r.date) = ? AND r.team_id = ?) b ON (a.date = b.date) ' +
        'ORDER BY date DESC';
    ...
    dbPool.getConnection(function(err, dbConn) {
        ...
        dbConn.query(sql_detail_error_state, [reqData.teamId, reqData.year, reqData.quarter, reqData.obstacleClassification, reqData.year, reqData.quarter, reqData.teamId], function(err, results) {
            dbConn.release();
            if (err) {
                return callback(err);
            }
...
function getCarState(callback) {
    ...
    var select_team_and_cars_by_date = "SELECT "+
                                        ...
                                        "CASE WHEN DAY(date) = 1 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day1, "+
                                        "CASE WHEN DAY(date) = 2 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day2, "+
                                        "CASE WHEN DAY(date) = 3 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day3, "+
                                        "CASE WHEN DAY(date) = 4 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day4, "+
                                        "CASE WHEN DAY(date) = 5 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day5, "+
                                        "CASE WHEN DAY(date) = 6 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day6, "+
                                        "CASE WHEN DAY(date) = 7 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day7, "+
                                        "CASE WHEN DAY(date) = 8 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day8, "+
                                        "CASE WHEN DAY(date) = 9 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day9, "+
                                        "CASE WHEN DAY(date) = 10 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day10, "+
                                        "CASE WHEN DAY(date) = 11 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day11, "+
                                        "CASE WHEN DAY(date) = 12 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day12, "+
                                        "CASE WHEN DAY(date) = 13 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day13, "+
                                        "CASE WHEN DAY(date) = 14 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day14, "+
                                        "CASE WHEN DAY(date) = 15 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day15, "+
                                        "CASE WHEN DAY(date) = 16 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day16, "+
                                        "CASE WHEN DAY(date) = 17 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day17, "+
                                        "CASE WHEN DAY(date) = 18 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day18, "+
                                        "CASE WHEN DAY(date) = 19 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day19, "+
                                        "CASE WHEN DAY(date) = 20 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day20, "+
                                        "CASE WHEN DAY(date) = 21 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day21, "+
                                        "CASE WHEN DAY(date) = 22 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day22, "+
                                        "CASE WHEN DAY(date) = 23 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day23, "+
                                        "CASE WHEN DAY(date) = 24 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day24, "+
                                        "CASE WHEN DAY(date) = 25 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day25, "+
                                        "CASE WHEN DAY(date) = 26 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day26, "+
                                        "CASE WHEN DAY(date) = 27 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day27, "+
                                        "CASE WHEN DAY(date) = 28 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day28, "+
                                        "CASE WHEN DAY(date) = 29 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day29, "+
                                        "CASE WHEN DAY(date) = 30 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day30, "+
                                        "CASE WHEN DAY(date) = 31 THEN CONCAT_WS(',', team_name, car_mileage_before, car_mileage_after, refueling_price) ELSE NULL END day31 "+
                                        "FROM report "+
                    ...
                    for (var i = 0; i < results.length; i++) {
                        ...
                        if (index === -1) { //배열에 그 car가 없을 때
                            data.dayDatas.push({
                                ...
                                day1RefuelingPrice: results[i].day1 === null ? '' : results[i].day1.split(',')[3],
                                ...
                                day2RefuelingPrice: results[i].day2 === null ? '' : results[i].day2.split(',')[3],
                                ...
                                day3RefuelingPrice: results[i].day1 === null ? '' : results[i].day3.split(',')[3],
                                ...
                                day4RefuelingPrice: results[i].day4 === null ? '' : results[i].day4.split(',')[3],
                                ...
                                day5RefuelingPrice: results[i].day5 === null ? '' : results[i].day5.split(',')[3],
                                ...
                                day6RefuelingPrice: results[i].day6 === null ? '' : results[i].day6.split(',')[3],
                                ...
                                day7RefuelingPrice: results[i].day7 === null ? '' : results[i].day7.split(',')[3],
                                ...
                                day8RefuelingPrice: results[i].day8 === null ? '' : results[i].day8.split(',')[3],
                                ...
                                day9RefuelingPrice: results[i].day9 === null ? '' : results[i].day9.split(',')[3],
                                ...
                                day10RefuelingPrice: results[i].day10 === null ? '' : results[i].day10.split(',')[3],
                                ...
                                day11RefuelingPrice: results[i].day11 === null ? '' : results[i].day11.split(',')[3],
                                ...
                                day12RefuelingPrice: results[i].day12 === null ? '' : results[i].day12.split(',')[3],
                                ...
                                day13RefuelingPrice: results[i].day13 === null ? '' : results[i].day13.split(',')[3],
                                ...
                                day14RefuelingPrice: results[i].day14 === null ? '' : results[i].day14.split(',')[3],
                                ...
                                day15RefuelingPrice: results[i].day15 === null ? '' : results[i].day15.split(',')[3],
                                ...
                                day16RefuelingPrice: results[i].day16 === null ? '' : results[i].day16.split(',')[3],
                                ...
                                day17RefuelingPrice: results[i].day17 === null ? '' : results[i].day17.split(',')[3],
                                ...
                                day18RefuelingPrice: results[i].day18 === null ? '' : results[i].day18.split(',')[3],
                                ...
                                day19RefuelingPrice: results[i].day19 === null ? '' : results[i].day19.split(',')[3],
                                ...
                                day20RefuelingPrice: results[i].day20 === null ? '' : results[i].day20.split(',')[3],
                                ...
                                day21RefuelingPrice: results[i].day21 === null ? '' : results[i].day21.split(',')[3],
                                ...
                                day22RefuelingPrice: results[i].day22 === null ? '' : results[i].day22.split(',')[3],
                                ...
                                day23RefuelingPrice: results[i].day23 === null ? '' : results[i].day23.split(',')[3],
                                ...
                                day24RefuelingPrice: results[i].day24 === null ? '' : results[i].day24.split(',')[3],
                                ...
                                day25RefuelingPrice: results[i].day25 === null ? '' : results[i].day25.split(',')[3],
                                ...
                                day26RefuelingPrice: results[i].day26 === null ? '' : results[i].day26.split(',')[3],
                                ...
                                day27RefuelingPrice: results[i].day27 === null ? '' : results[i].day27.split(',')[3],
                                ...
                                day28RefuelingPrice: results[i].day28 === null ? '' : results[i].day28.split(',')[3],
                                ...
                                day29RefuelingPrice: results[i].day29 === null ? '' : results[i].day29.split(',')[3],
                                ...
                                day30RefuelingPrice: results[i].day30 === null ? '' : results[i].day30.split(',')[3],
                                ...
                                day31RefuelingPrice: results[i].day31 === null ? '' : results[i].day31.split(',')[3],
                            });
                            ...
                            for (var j = 1; j <= 31; j++) {
                                ...
                                if (!data.dayDatas[index][day]) {
                                    ...
                                    data.dayDatas[index][day + 'RefuelingPrice'] = (results[i][day] === null ? '' : results[i][day].split(',')[3]);
                                }
                            }
                        }
                    }
